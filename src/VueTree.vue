...
export default {
  ...
  emits : [
    ...
    'dragstart', 'dragover', 'dragenter', 'dragleave', 'dragentertree', 'dragleavetree', 'dragend', 'drop',
    'move',
    'expand', 'collapse',
    'check', 'uncheck', 'checkbox-state-change'
  ],
  data() {
    return {
      //-----basic----
  ...
  methods: {
    ...
    getAttr() {
      if (arguments.length === 2) {
        ...
        if (Object.prototype.hasOwnProperty.call(node, key) === true) {
          return node[key]
        }

        if (Object.prototype.hasOwnProperty.call(this.defaultAttrs, key) === true) {
          return this.defaultAttrs[key]
        }

        if (Object.prototype.hasOwnProperty.call(this.spareDefaultAttrs, key) === true) {
      ...
      if (arguments.length === 3) {
        ...
        if (Object.prototype.hasOwnProperty.call(node, key) === true && Object.prototype.hasOwnProperty.call(node[key], subKey) === true) {
          return node[key][subKey]
        }

        if (Object.prototype.hasOwnProperty.call(this.defaultAttrs, key) === true && Object.prototype.hasOwnProperty.call(this.defaultAttrs[key], subKey) === true) {
          return this.defaultAttrs[key][subKey]
        }

        if (Object.prototype.hasOwnProperty.call(this.spareDefaultAttrs, key) === true && Object.prototype.hasOwnProperty.call(this.spareDefaultAttrs[key], subKey) === true) {
    ...
    getTitleElement(node) {
      ...
      if (Object.prototype.hasOwnProperty.call(this.$refs, refId) === true) {
        return this.$refs[refId][0].children[0]
      }
    ...
    create(node, parentNode, pos) {
      if (parentNode === null) {
        ...
        if (Object.prototype.hasOwnProperty.call(parentNode, 'children') === false) {
          parentNode.children = []
        }
        if (typeof(pos) === 'undefined') {
    ...
    move(node, toParent, toPos) {
      ...
      if (toParent === null) {
        ...
        if (Object.prototype.hasOwnProperty.call(toParent, 'children') === false) {
          toParent.children = []
        }
        if (typeof(toPos) === 'undefined') {
    ...
    getDirectoryState(node) {
      ...
      if (directoryState === null) {
        directoryState = (Object.prototype.hasOwnProperty.call(this.defaultAttrs, 'directoryState') === true && this.defaultAttrs.directoryState !== null)
    ...
    getHiddenTitleWidth(node) {
      ...
      if (Object.prototype.hasOwnProperty.call(this.$refs, hiddenRefId) === true) {
    ...
    //------------------------------ global cache --------------------------------------
    setGlobalCache() {
      if (Object.prototype.hasOwnProperty.call(window, 'vueTreeCache') === false) {
        window.vueTreeCache = {}
      }
      ...
      if (arguments.length === 2) {
        let key = arguments[0]
        let val = arguments[1]
        window.vueTreeCache[key] = val
      } else if (arguments.length === 3) {
        let key = arguments[0]
        let subKey = arguments[1]
        let val = arguments[2]
        if (Object.prototype.hasOwnProperty.call(window.vueTreeCache, key) === false) {
          window.vueTreeCache[key] = {}
        }
        window.vueTreeCache[key][subKey] = val
      }
    },
    getGlobalCache() {
      if (arguments.length === 1) {
        let key = arguments[0]
        return window?.vueTreeCache?.[key]
      } else if (arguments.length === 2) {
        let key = arguments[0]
        let subKey = arguments[1]
        return window?.vueTreeCache?.[key]?.[subKey]
      }
    },
    ...
    dragStartEvent(node, event) {
      ...
      event.dataTransfer.setData('vue-tree', JSON.stringify({
        'treeId': this.treeId,
        'nodeId': node.id
      }))
...
.vue-tree-node .vue-tree-switcher-wrapper .vue-tree-switcher-icon.vue-tree-switcher-loading {
  animation-name: spin;
...
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-checked:after {
  content: "";
...
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-checked {
  color: white;
  background-color: #2d8cf0;
  border-color: #2d8cf0;
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-checked.vue-tree-checkbox-disabled {
  border-color: #dcdee2;
  background-color: #f5f5f5;
  cursor: not-allowed;
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-checked.vue-tree-checkbox-disabled:after {
  border-color: #a6a6a6;
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-unchecked {
  background-color: white;
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-unchecked.vue-tree-checkbox-disabled {
  background-color: #f5f5f5;
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-undetermined:after{
  content: '';
  border: 0;
  padding: 0;
  margin: 0;
...
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-undetermined{
  color: white;
  background-color: #2d8cf0;
  border-color: #2d8cf0;
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-undetermined.vue-tree-checkbox-disabled{
  border-color: #dcdee2;
  background-color: #f5f5f5;
}
.vue-tree-node .vue-tree-checkbox-wrapper .vue-tree-checkbox.vue-tree-checkbox-undetermined.vue-tree-checkbox-disabled:after{
