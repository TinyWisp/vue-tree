<template>
  <div class="example-wrapper">
    ...
    <div class="panel">
      <vue-tree :tree="commonTree" ref="dndtree" class="tree">
    ...
    <div class="panel">
      <vue-tree :tree="commonTree" ref="ctree" class="tree" :defaultAttrs="{checkbox:{show:true}}">
    ...
    <div class="panel">
      <vue-tree :tree="extraTree" class="tree" :defaultAttrs="{style:{extraFloatRight:true}}">
    ...
    <div class="panel">
      <vue-tree :tree="widthTree" class="tree" :defaultAttrs="{style:{titleMaxWidth: '3em', titleOverflow: 'ellipsis'}}">
      </vue-tree>
    </div>
    <div class="panel">
      <vue-tree :tree="widthTree" class="tree" :defaultAttrs="{style:{titleMaxWidth: '20%', titleOverflow: 'ellipsis'}}">
      </vue-tree>
    </div>
    <div class="panel">
      <vue-tree :tree="widthTree" class="tree" :defaultAttrs="{style:{titleMaxWidth: '-20%', titleOverflow: 'ellipsis'}}">
